    ...
    <AnimatePresence>
      {isOpen && (
        <Dialog open={isOpen} onOpenChange={onClose}>
          <DialogContent className="relative overflow-hidden bg-gradient-to-b from-gray-800/95 to-gray-900/95 border border-gray-700/50 shadow-xl backdrop-blur-xl rounded-2xl max-w-md mx-auto">
            <motion.div
            ...
            <DialogHeader className="relative">
              ...
              >
                <DialogTitle className="text-2xl font-bold text-center mt-8 mb-6">
            ...
            >
              ...
              >
                <Button
                  onClick={onClose}
                  className={`relative bg-gradient-to-r ${gradientColors.button} text-white font-medium px-8 py-2.5 rounded-xl shadow-lg transition-all duration-300`}
                  style={{
